  ...
  return (
    <>
      ...
      <button
        ...
        onClick={onClose}
        aria-label="Cerrar"
        className="absolute top-3.5 right-3.5 w-[30px] h-[30px] rounded-full border-0 bg-black/5 text-[color:var(--color-text-soft)] text-[17px] leading-none flex items-center justify-center transition-all duration-200 ease-out hover:bg-black/10 hover:text-[color:var(--color-ink)] hover:rotate-90 focus-visible:outline-2 focus-visible:outline-[color:var(--color-ink-soft)] focus-visible:outline-offset-2"
      >
